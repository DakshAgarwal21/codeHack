...
public class MemoriesFragment extends Fragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    ArrayList<com.collegemeet.android.revafest.PostFeedDetailsClass> list;
    private HashSet<String> hashSet;
    com.collegemeet.android.revafest.PostFeedAdapterClass adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list = new ArrayList<>();
        adapter = new com.collegemeet.android.revafest.PostFeedAdapterClass(getContext(), list);
...
//                                    String profileImage = documentSnapshot.getString("profile image");
                                        ...
                                        if (documentSnapshot.getString("profile image") != null) {
                                            list.add(new com.collegemeet.android.revafest.PostFeedDetailsClass(name,
