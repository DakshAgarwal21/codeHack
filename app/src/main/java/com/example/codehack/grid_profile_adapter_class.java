...
public class grid_profile_adapter_class extends RecyclerView.Adapter {
    ...
    private ArrayList<com.collegemeet.android.revafest.PostFeedDetailsClass> list;
    ...
    public grid_profile_adapter_class(Context context, ArrayList<com.collegemeet.android.revafest.PostFeedDetailsClass> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder.getClass() == VideoHolder.class){
            ...
            holder.itemView.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(context , com.collegemeet.android.revafest.profileFullSizeImage.class);
            ...
            holder.itemView.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(context , com.collegemeet.android.revafest.ProfileFullSizeImageUser.class);
                Bundle bundle = new Bundle();
