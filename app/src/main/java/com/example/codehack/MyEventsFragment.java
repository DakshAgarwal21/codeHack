...
public class MyEventsFragment extends Fragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private com.collegemeet.android.revafest.VlogProfileAdapterClass adapter;

    private HashSet<String> hashSet;
    private String key = null;
    private LinearLayoutManager manager;
    private FirebaseFirestore firestore;
    private ArrayList<com.collegemeet.android.revafest.VlogFetchDetailsClass> list;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new com.collegemeet.android.revafest.VlogProfileAdapterClass(getContext(), list);
                        ...
                        if (hashSet.contains(documentChange.getDocument().getString("evenName"))) {
                            ...
                            if (documentChange.getDocument().getString("eventName") != null ||
                                ...
                                if (documentChange != null && documentChange.getType() == DocumentChange.Type.ADDED) {
                                    ...
                                    //list
                                    list.add(new com.collegemeet.android.revafest.VlogFetchDetailsClass(documentChange.getDocument().getString("eventImage")
