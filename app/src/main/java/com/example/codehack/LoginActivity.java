    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LoginActivity.this , com.collegemeet.android.revafest.SignUpActivity.class);
...
//                    snackbar.show();
    ...
    private void sendToMainActivity(){
        ...
        Intent intent = new Intent(LoginActivity.this, com.collegemeet.android.revafest.MainActivityContainingFragment.class);
        startActivity(intent);
