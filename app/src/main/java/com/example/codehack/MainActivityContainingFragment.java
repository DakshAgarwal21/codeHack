...
public class MainActivityContainingFragment extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myEventFragment = new com.collegemeet.android.revafest.MyEventsFragment();
        allEventFragment = new AllEventFragment();
        memoriesFragment = new com.collegemeet.android.revafest.MemoriesFragment();
        notificationFragment = new com.collegemeet.android.revafest.NotificationFragment();
        profileFragment = new com.collegemeet.android.revafest.ProfileFragment();
